...
var lastNameStorage = document.getElementById("lastnameStorage");
var secondNameStorage = document.getElementById("secondnameStorage");
var ageStorage = document.getElementById("ageStorage");
var lastNameValue = document.getElementById("lastnameStorageOutput");
var secondNameValue = document.getElementById("secondnameStorageOutput");
var ageValue = document.getElementById("ageStorageOutput");
...
buttonReg.onclick = function(){
	localStorage.setItem("lastname",lastNameStorage);
	localStorage.setItem("secondname",secondNameStorage);
	localStorage.setItem("age",ageStorage);
	window.location.href = 'welcome.html';
	lastNameValue.textContent = localStorage.getItem("lastname");
	secondNameValue.textContent = localStorage.getItem("secondname");
	ageValue.textContent = localStorage.getItem("age");
}